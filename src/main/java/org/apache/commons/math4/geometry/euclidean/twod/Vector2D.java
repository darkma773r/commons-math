 ...
 * @since 4.0
 */
public class Vector2D extends Cartesian2D implements Vector<Euclidean2D> {
    ...
    public Vector2D(double a1, Vector2D u1, double a2, Vector2D u2,
        ...
        super(a1 * u1.x + a2 * u2.x + a3 * u3.x + a4 * u4.x,
                a1 * u1.y + a2 * u2.y + a3 * u3.y + a4 * u4.y);
    }
     ...
     */
    public double distance(Vector2D c) {
