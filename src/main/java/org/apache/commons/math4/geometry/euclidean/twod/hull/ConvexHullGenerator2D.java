 ...
 * @since 3.3
 */
public interface ConvexHullGenerator2D extends ConvexHullGenerator<Euclidean2D, Point2D> {

    /** {@inheritDoc} */
    @Override
    ConvexHull2D generate(Collection<Point2D> points) throws NullArgumentException, ConvergenceException;
