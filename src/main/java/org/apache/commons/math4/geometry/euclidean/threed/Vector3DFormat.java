...
public class Vector3DFormat extends VectorFormat<Euclidean3D> {
    ...
    /**
     * Formats a {@link Vector3D_} object to produce a string.
    ...
    public StringBuffer format(final Vector<Euclidean3D> vector, final StringBuffer toAppendTo,
        ...
        final Vector3D_ v3 = (Vector3D_) vector;
        return format(toAppendTo, pos, v3.getX(), v3.getY(), v3.getZ());
    }

    /**
     * Parses a string to produce a {@link Vector3D_} object.
     * @param source the string to parse
     * @return the parsed {@link Vector3D_} object.
     * @throws MathParseException if the beginning of the specified string
     * cannot be parsed.
     */
    @Override
    public Vector3D_ parse(final String source) throws MathParseException {
        ParsePosition parsePosition = new ParsePosition(0);
        Vector3D_ result = parse(source, parsePosition);
     ...
     */
    @Override
    public Vector3D_ parse(final String source, final ParsePosition pos) {
