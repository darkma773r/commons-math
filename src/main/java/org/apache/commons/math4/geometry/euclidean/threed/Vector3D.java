...
/**
 * This class represents vectors in a three-dimensional space.
 ...
 * @since 4.0
 */
public class Vector3D extends Cartesian3D implements Vector<Euclidean3D> {
   ...
   public Vector3D(double a1, Vector3D u1, double a2, Vector3D u2,
       ...
       super(LinearCombination.value(a1, u1.x, a2, u2.x, a3, u3.x),
               LinearCombination.value(a1, u1.y, a2, u2.y, a3, u3.y),
               LinearCombination.value(a1, u1.z, a2, u2.z, a3, u3.z));
   }
   ...
   public Vector3D(double a1, Vector3D u1, double a2, Vector3D u2,
       ...
       super(LinearCombination.value(a1, u1.x, a2, u2.x, a3, u3.x, a4, u4.x),
               LinearCombination.value(a1, u1.y, a2, u2.y, a3, u3.y, a4, u4.y),
               LinearCombination.value(a1, u1.z, a2, u2.z, a3, u3.z, a4, u4.z));
   }
   ...
   public Point3D asPoint() {
    ...
    public Vector3D crossProduct(final Vector<Euclidean3D> v) {
        final Vector3D v3 = (Vector3D) v;
        return new Vector3D(LinearCombination.value(y, v3.z, -z, v3.y),
     ...
     */
    public double distance(Vector3D c) {
