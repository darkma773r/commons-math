...
public class SubOrientedPointTest {
    ...
    public void testSplit_usesToleranceFromParentHyperplane() {
        ...
        // act/assert
        SplitSubHyperplane<Euclidean1D> plusSplit = pt.split(new OrientedPoint(new Point1D(0.899), true, 1e-10));
        Assert.assertNull(plusSplit.getMinus());
        Assert.assertNotNull(plusSplit.getPlus());

        SplitSubHyperplane<Euclidean1D> lowWithinTolerance = pt.split(new OrientedPoint(new Point1D(0.901), true, 1e-10));
        Assert.assertNull(lowWithinTolerance.getMinus());
        Assert.assertNull(lowWithinTolerance.getPlus());

        SplitSubHyperplane<Euclidean1D> highWithinTolerance = pt.split(new OrientedPoint(new Point1D(1.09), true, 1e-10));
        Assert.assertNull(highWithinTolerance.getMinus());
        Assert.assertNull(highWithinTolerance.getPlus());

        SplitSubHyperplane<Euclidean1D> minusSplit = pt.split(new OrientedPoint(new Point1D(1.101), true, 1e-10));
