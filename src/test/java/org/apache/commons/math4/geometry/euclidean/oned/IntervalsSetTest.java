...
public class IntervalsSetTest {
    ...
    public void testInterval_wholeNumberLine() {
        ...
        GeometryTestUtils.assertVectorEquals(Point1D.NaN, (Point1D) set.getBarycenter(), TEST_TOLERANCE);
    ...
    public void testInterval_singleClosedInterval() {
        ...
        Assert.assertEquals(0.0, set.getBoundarySize(), TEST_TOLERANCE);
        GeometryTestUtils.assertVectorEquals(new Point1D(4.0), (Point1D) set.getBarycenter(), TEST_TOLERANCE);
    ...
    public void testInterval_singlePoint() {
        ...
        Assert.assertEquals(0.0, set.getBoundarySize(), TEST_TOLERANCE);
        GeometryTestUtils.assertVectorEquals(new Point1D(1.0), (Point1D) set.getBarycenter(), TEST_TOLERANCE);
    ...
    public void testFromBoundaries_multipleClosedIntervals() {
        ...
        Assert.assertEquals(0.0, set.getBoundarySize(), TEST_TOLERANCE);
        GeometryTestUtils.assertVectorEquals(new Point1D(29.5 / 7.0), (Point1D) set.getBarycenter(), TEST_TOLERANCE);
    ...
    public void testFromBoundaries_mixedOpenAndClosedIntervals() {
        ...
        GeometryTestUtils.assertPositiveInfinity(set.getSize());
        Assert.assertEquals(0.0, set.getBoundarySize(), TEST_TOLERANCE);
        GeometryTestUtils.assertVectorEquals(new Point1D(Double.NaN), (Point1D) set.getBarycenter(), TEST_TOLERANCE);
    ...
    public void testInterval() {
        ...
        Assert.assertEquals(4.0, ((Point1D) set.getBarycenter()).getX(), 1.0e-10);
    ...
    public void testBooleanOperations() {
        ...
        Assert.assertEquals(5.9, ((Point1D) set.getBarycenter()).getX(), TEST_TOLERANCE);
    ...
    private void assertProjection(Point1D expectedProjection, double expectedOffset,
        ...
        GeometryTestUtils.assertVectorEquals(toProject, (Point1D) proj.getOriginal(), TEST_TOLERANCE);
        GeometryTestUtils.assertVectorEquals(expectedProjection, (Point1D) proj.getProjected(), TEST_TOLERANCE);
