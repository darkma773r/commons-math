...
public class SphereGeneratorTest {
    ...
    public void testSupport0Point() {
        ...
        EnclosingBall<Euclidean3D, Point3D> sphere = new SphereGenerator().ballOnSupport(support);
    ...
    public void testRandom() {
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            for (int j = 0; j < 5; ++j) {
                support.add(new Point3D(1.0, refCenter, refRadius, new Point3D(sr.nextVector())));
            }
            EnclosingBall<Euclidean3D, Point3D> sphere = new SphereGenerator().ballOnSupport(support);
