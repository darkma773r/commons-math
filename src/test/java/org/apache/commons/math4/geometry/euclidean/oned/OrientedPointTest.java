...
public class OrientedPointTest {
    ...
    public void testGetOffset_direct_vector() {
        ...
        // act/assert
        Assert.assertEquals(-99, pt.getOffset(new Vector1D(-100)), Precision.EPSILON);
        Assert.assertEquals(-1, pt.getOffset(new Vector1D(-2)), Precision.EPSILON);
        Assert.assertEquals(-0.01, pt.getOffset(new Vector1D(-1.01)), Precision.EPSILON);
        Assert.assertEquals(-0.0, pt.getOffset(new Vector1D(-1.0)), Precision.EPSILON);
        Assert.assertEquals(0.01, pt.getOffset(new Vector1D(-0.99)), Precision.EPSILON);
        Assert.assertEquals(1, pt.getOffset(new Vector1D(0)), Precision.EPSILON);
        Assert.assertEquals(101, pt.getOffset(new Vector1D(100)), Precision.EPSILON);
    }
    ...
    public void testRevertSelf() {
        ...
        Assert.assertEquals(1, pt.getOffset(new Vector1D(1.0)), Precision.EPSILON);
        Assert.assertEquals(-1, pt.getOffset(new Vector1D(3.0)), Precision.EPSILON);
    }
}
