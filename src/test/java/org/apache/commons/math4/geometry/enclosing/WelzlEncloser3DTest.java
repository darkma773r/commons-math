...
public class WelzlEncloser3DTest {
    ...
    public void testNullList() {
        ...
        WelzlEncloser<Euclidean3D, Point3D> encloser =
                new WelzlEncloser<>(1.0e-10, generator);
        EnclosingBall<Euclidean3D, Point3D> ball = encloser.enclose(null);
    ...
    public void testNoPoints() {
        ...
        WelzlEncloser<Euclidean3D, Point3D> encloser =
                new WelzlEncloser<>(1.0e-10, generator);
        EnclosingBall<Euclidean3D, Point3D> ball = encloser.enclose(new ArrayList<Point3D>());
        Assert.assertTrue(ball.getRadius() < 0);
    }
    ...
    public void testReducingBall() {
        ...
        EnclosingBall<Euclidean3D, Point3D> ball = encloser.enclose(list);
        Assert.assertTrue(ball.getRadius() > 0);
    }
    ...
    public void testLargeSamples() throws IOException {
        ...
        for (int k = 0; k < 50; ++k) {
            ...
            Point3D refCenter = new Point3D(d, new Point3D(sr.nextVector()));
            // set up a large sample inside the reference sphere
            int nbPoints = random.nextInt(1000);
            List<Point3D> points = new ArrayList<>();
            for (int i = 0; i < nbPoints; ++i) {
                double r = refRadius * random.nextDouble();
                points.add(new Point3D(1.0, refCenter, r, new Point3D(sr.nextVector())));
            }
    ...
    private void checkSphere(List<Point3D> points, double refRadius) {
        ...
        EnclosingBall<Euclidean3D, Point3D> sphere = checkSphere(points);
        ...
        for (int i = 0; i < sphere.getSupportSize(); ++i) {
            ...
            EnclosingBall<Euclidean3D, Point3D> reducedSphere =
    ...
    private EnclosingBall<Euclidean3D, Point3D> checkSphere(List<Point3D> points) {

        WelzlEncloser<Euclidean3D, Point3D> encloser =
                new WelzlEncloser<>(1.0e-10, new SphereGenerator());
        EnclosingBall<Euclidean3D, Point3D> Sphere = encloser.enclose(points);
