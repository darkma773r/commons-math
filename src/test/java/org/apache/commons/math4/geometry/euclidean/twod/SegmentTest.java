...
public class SegmentTest {
    ...
    public void testDistance() {
        ...
        Assert.assertEquals(FastMath.sqrt(2), segment.distance(new Point2D(1, -1)), 1.0e-10);

        // distance a point on segment
        Assert.assertEquals(FastMath.sin(Math.PI / 4.0), segment.distance(new Point2D(0, -1)), 1.0e-10);

        // distance to end point
        Assert.assertEquals(FastMath.sqrt(8), segment.distance(new Point2D(0, 4)), 1.0e-10);
